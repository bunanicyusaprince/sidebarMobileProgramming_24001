  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 155, 151, 112),
      ),
      body: Padding(
          ...
          children: [
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      color: const Color.fromARGB(255, 165, 140, 140),
                      fontSize: 100,
                    ),
                  ),
                ),
            ...
            Row(
              ...
              children: [
                ...
                calcbutton('%', Colors.grey, Colors.black),
                calcbutton('/', Colors.amber[700]!,
                    const Color.fromARGB(255, 231, 190, 187)),
              ],
            ), //Row
            SizedBox(
              height: 10,
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    primary: const Color.fromARGB(255, 231, 190, 187),
                  ),
                  child: Text(
                    "0",
                    style: TextStyle(
